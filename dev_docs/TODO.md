...
- [x] deploy all refactored lambdas onto dev and run Postman verification for each deployed route set (2026-04-23: automated smoke tests at `postman/` — 33 requests / 99 assertions all green; see section below)
