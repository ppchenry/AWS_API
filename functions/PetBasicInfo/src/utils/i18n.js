 ...
 * Caches the result at module scope so the file is only read once per language per Lambda container.
 *
 ...
 * @param {string} key The dotted translation key, for example `petBasicInfo.errors.petNotFound`.
