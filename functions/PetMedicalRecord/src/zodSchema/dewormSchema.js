...
const createDewormRecordSchema = z.object({
  date: z.string({ error: "petMedicalRecord.errors.dewormRecord.invalidDateFormat" }).optional(),
  ...
  nextDewormDate: z.string({ error: "petMedicalRecord.errors.dewormRecord.invalidDateFormat" }).optional(),
