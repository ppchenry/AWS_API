...
const PetAdoptionSchema = new mongoose.Schema(
  {
    ...
    postAdoptionName: { type: String, default: null },
    isNeutered: { type: Boolean, default: null },
    NeuteredDate: { type: Date, default: null },
    firstVaccinationDate: { type: Date, default: null },
    secondVaccinationDate: { type: Date, default: null },
    thirdVaccinationDate: { type: Date, default: null },
