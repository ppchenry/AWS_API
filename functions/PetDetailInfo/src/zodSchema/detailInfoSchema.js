...
const detailInfoUpdateSchema = z.object({
  ...
  motherDOB: z.string({ error: "petDetailInfo.invalidDateFormat" }).optional(),
  motherChip: z.string().optional(),
  motherPlaceOfBirth: z.string().optional(),
  motherParity: z.coerce.number({ error: "petDetailInfo.invalidMotherParity" }).optional(),
  fatherName: z.string().optional(),
  fatherBreed: z.string().optional(),
  fatherDOB: z.string({ error: "petDetailInfo.invalidDateFormat" }).optional(),
